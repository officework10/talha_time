...
class MonthsFromNow extends Component
{
    public $error = null;
    public $detail = null;
    public $lang = [];
    ...
    public function calculate()
    {
        ...
        $result = app(CalculatorRepositoryInterface::class)->months_from(new Request((array)$request));
        // dd($result);
    ...
    public function render()
    {
       ...
       JS);
        ...
        return view('livewire.calculators.months-from-now-calculator');
    }
}
