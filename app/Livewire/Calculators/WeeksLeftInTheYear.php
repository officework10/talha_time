...
class WeeksLeftInTheYear extends Component
{
    public $error = null;
    public $detail = null;
    public $lang = [];
    ...
    public function calculate()
    {
        ...
        $result = app(CalculatorRepositoryInterface::class)->weeks_left(new Request((array)$request));
    ...
    public function render()
    {
       ...
       JS);
        ...
        return view('livewire.calculators.weeks-left-in-the-year');
    }
}
