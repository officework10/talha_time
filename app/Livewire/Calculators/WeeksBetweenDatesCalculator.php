...
class WeeksBetweenDatesCalculator extends Component
{
    public $error = null;
    public $detail = null;
    public $lang = [];
    ...
    public function calculate()
    {
        ...
        $result = app(CalculatorRepositoryInterface::class)->weeks_between(new Request((array)$request));
        // dd($result);
    ...
    public function render()
    {
       ...
       JS);
        ...
        return view('livewire.calculators.weeks-between-dates-calculator');
    }
}
