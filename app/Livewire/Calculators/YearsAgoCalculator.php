...
class YearsAgoCalculator extends Component
{
    public $error = null;
    public $detail = null;
    public $lang = [];
    ...
    public $days = [4, 8, 12, 16, 20, 24, 30];
    public $current;
    ...
    public function calculate()
    {
        ...
        $result = app(CalculatorRepositoryInterface::class)->year_ago(new Request((array)$request));
        // dd($result);
    ...
    public function render()
    {
       ...
       JS);
        ...
        return view('livewire.calculators.years-ago-calculator');
    }
}
