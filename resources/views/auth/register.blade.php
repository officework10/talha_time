...
@section('content')
    <div class="flex justify-center items-center   relative"
        style="background-image: url('{{ asset('assets/images/auth-bg-img.png') }}');background-size: cover;">
        ...
        <div class="z-10 flex 2xl:w-[65%] xl:w-[70%] lg:w-[75%] w-[90%]  my-10 bg-white rounded-[25px]">
            <div class="lg:w-[50%] lg:rounded-[0px] rounded-[25px] w-[100%] 2xl:my-8 xl:my-4 lg:my-2 my-3 2xl:px-[50px] xl:px-[40px] lg:px-[35px] px-6"
                style="background-image: url('{{ asset('assets/images/login-bg-img.png') }}');background-size: cover;">

                <a href="{{ url('/') }}" class="flex my-5 items-center text-left  space-x-3 rtl:space-x-reverse mr-auto">
                ...
                @endif
                    <div>
                        <label for="first_name"
                            class="block my-2 pl-5 xl:text-[14px] lg:text-[12px] text-[14px] font-medium text-[#A3A3A3]">Name</label>
                        <input type="text" id="first_name" name="name"
                            class="bg-white border-[#F0F0F0] rounded-[36.5px] border-2 text-gray-900 text-sm  block w-full 2xl:p-5 xl:p-4 lg:p-3 p-3 "
                    ...
                    <div class="relative">
                        <label for="password"
                            class="block my-2 pl-5 xl:text-[14px] lg:text-[12px] text-[14px] font-medium text-[#A3A3A3]">Enter
                            Password (more then 9 characters)</label>
                        <div class="relative">
                            <input type="password" id="password" name="password"
                                class="bg-white border-[#F0F0F0] rounded-[36.5px] border-2 text-gray-900 text-sm  block w-full 2xl:p-5 xl:p-4 lg:p-3 p-3 pr-[50px]"
                    ...
                    <div class="relative">
                        <label for="passwordConfirm"
                            class="block my-2 pl-5  xl:text-[14px] lg:text-[12px] text-[14px] font-medium text-[#A3A3A3]">Confirm
                            Password</label>
                        <div class="relative">
                            <input type="password" id="passwordConfirm" name="password_confirmation"
                                class="bg-white border-[#F0F0F0] rounded-[36.5px] border-2 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full 2xl:p-5 xl:p-4 lg:p-3 p-3 pr-[50px]"
                            ...
                            <!-- SVG icon for toggle -->
                            <div class="absolute inset-y-0 right-3 flex items-center pr-4">
                                <button id="togglePasswordConfirm" type="button">
                                    <!-- SVG for hide (initial state) -->
                                    <svg id="hideIconConfirm" xmlns="http://www.w3.org/2000/svg" width="25"
                                    ...
                                    <!-- SVG for show (hidden initially) -->
                                    <svg width="25" height="19" viewBox="0 0 25 19" id="showIconConfirm"
                    ...
                    <div class="flex justify-center xl:my-5 my-3">
                        <button type="submit"
