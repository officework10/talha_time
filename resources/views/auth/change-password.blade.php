...
@section('content')
    <div class="max-w-[1140px] mx-auto lg:px-0 px-5 my-10">
        ...
        <form action="{{ url('change-password') }}" method="POST">
            @csrf
            <div class="max-w-screen-lg mx-auto justify-center  mt-14">
                <div

                    class="flex mx-auto justify-center lg:w-[50%] md:w-[50%] w-full flex-col xl:my-8 lg:my-6 my-4 gap-x-5 gap-y-4">
                
                    <p class="text-[30px] text-center font-bold pb-4">Change Password</p>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <div class="absolute top-4 right-0 flex items-center pr-4">
                                    <button id="CurrenttogglePassword" type="button">
                                        <!-- SVG for hide (initial state) -->
                                        <svg id="hideIconfirst" xmlns="http://www.w3.org/2000/svg" width="25"
                                        ...
                                        <svg width="25" height="19" viewBox="0 0 25 19" id="showIconfirst"
    ...
    <script>
        const CurrenttogglePassword = document.getElementById("CurrenttogglePassword");
        const current_passwordInput = document.getElementById("current_password");
        const hideIconfirst = document.getElementById("hideIconfirst");
        const showIconfirst = document.getElementById("showIconfirst");

        CurrenttogglePassword.addEventListener("click", function() {
            // Toggle the password visibility
            const type =
                current_passwordInput.getAttribute("type") === "password" ?
                "text" :
                "password";
            current_passwordInput.setAttribute("type", type);

            // Toggle the SVG icons
            hideIconfirst.classList.toggle("hidden");
            showIconfirst.classList.toggle("hidden");
        });
    </script>
