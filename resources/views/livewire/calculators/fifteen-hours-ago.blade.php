    ...
    <div class="w-full mx-auto p-6 lg:p-10 bg-white rounded-3xl shadow-xl space-y-8 my-6 border border-gray-100">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <div class="max-w-md mx-auto mt-10">
                ...
                <input type="number" id="hours-input" value="15" min="0" 
                    class=" input"
    ...
    <script>
        function updateClock() {
            ...
            function tick() {
                ...
                // Calculate past time
                const pastTime = new Date(now.getTime() - (offsetHours * 60 * 60 * 1000));
                
                const seconds = pastTime.getSeconds();
                ...
                digitalTime.textContent = pastTime.toLocaleTimeString('en-US', { 
                    hour: '2-digit', 
                    minute: '2-digit', 
                    second: '2-digit', 
                    hour12: true 
                ...
                // Update date display
                fullDate.textContent = pastTime.toLocaleDateString('en-US', { 
                    weekday: 'long', 
                    year: 'numeric', 
                    month: 'long', 
                    day: 'numeric' 
