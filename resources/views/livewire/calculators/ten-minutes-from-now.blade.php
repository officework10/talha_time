<div>
    ...
    <div class="w-full mx-auto p-6 lg:p-10 bg-white rounded-3xl shadow-xl space-y-8 my-6 border border-gray-100">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <div id="future-display" class="space-y-2 mb-8">
                ...
                <p id="full-date" class="text-xl font-semibold text-gray-600">--</p>
            </div>
            ...
            <div class="max-w-md mx-auto mt-10">
                <label for="minutes-input" class="block text-sm font-bold text-gray-500 uppercase tracking-wider mb-2 text-left">
                    Minutes from now:
                </label>
                <input type="number" id="minutes-input" wire:model.live="minutes" min="0" 
                    class="input"
    ...
    <script>
        function updateClock() {
            ...
            function tick() {
                const now = new Date();
                const offsetMinutes = parseFloat(minutesInput.value) || 0;
            ...
            minutesInput.addEventListener('input', tick);
