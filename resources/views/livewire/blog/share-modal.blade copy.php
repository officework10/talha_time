            ...
            <div class="flex items-center my-4 lg:flex-row md:flex-row flex-col px-2">
                ...
                <div class="lg:w-[20%] md:w-[20%] w-full text-end">
                    <button wire:click="openShareModal"
                        class="bg-transparent border z-50 border-gray-300 hover:border-[#55be30] text-[#000] hover:bg-[#55be30] hover:text-white duration-200 text-[16px] rounded-[44px] px-6 py-3">
                        Share
                    </button>
                </div>
            </div>
            ...
            <div x-data @click.outside="$wire.closeShareModal()"
                ...
                <div class="flex justify-center space-x-4 mb-6">
                    <button wire:click="share('facebook')"
                        class="bg-blue-600 rounded-full p-2 text-white hover:bg-blue-700">
                    ...
                    <button wire:click="share('twitter')"
                        class="bg-blue-400 rounded-full p-2 text-white hover:bg-blue-500">
                    ...
                    <button wire:click="share('linkedin')"
                        class="bg-blue-500 rounded-full p-2 text-white hover:bg-blue-600">
                    ...
                    <button wire:click="share('email')"
                        class="bg-green-500 rounded-full p-2 text-white hover:bg-green-600">
